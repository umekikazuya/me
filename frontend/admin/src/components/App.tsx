      ...
      <AdminShell authenticated={isAuthenticated}>
        <AuthBoundary authRepo={authRepo}>
          <Routes>
            ...
            <Route path="/articles" element={<ArticlesPage articleRepo={articleRepo} />} />
            <Route path="/profile" element={<ProfilePage profileRepo={profileRepo} />} />
            <Route path="/account" element={<AccountPage authRepo={authRepo} />} />
          </Routes>
        </AuthBoundary>
      </AdminShell>
    </BrowserRouter>
